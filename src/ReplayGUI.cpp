...
ReplayGui::ReplayGui(std::function<void(QStandardItemModel*, ReplayHandler*)> updateTaskViewCallback, QMainWindow *parent)
    : QMainWindow(parent)
    , updateTaskViewCallback(updateTaskViewCallback)
{
    ui.setupUi(this);
